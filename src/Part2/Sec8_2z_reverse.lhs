|Markdown version of this file: https://github.com/rpeszek/IdrisTddNotes/wiki/Part2_Sec8_2z_reverse
|Idris Src: Sec8_2z_reverse.idr

Section 8.2 Vect reverse vs Haskell
===================================
This is best read after [Part2_Sec8_2_5_vappd](Part2_Sec8_2_5_vappd).
This note imports `plusZeroRightNeutral`, `plusSuccRightSucc`, `plusCommutative`, 
and `myAppend` from [Part2_Sec8_2_5_vappd](Part2_Sec8_2_5_vappd).

Idris code example
------------------  
|IdrisRef: Sec8_2z_reverse.idr 
...
>
> module Part2.Sec8_2z_reverse where
> import Data.CodedByHand (Vect(..), Nat(..), SNat(..), type (+), SNatI, sNat)
> import Data.Type.Equality ((:~:)(Refl))
> import Part2.Sec8_2_5_vappd (plusZeroRightNeutral, plusSuccRightSucc, plusCommutative, myAppend)
>
> {- slow reverse -}

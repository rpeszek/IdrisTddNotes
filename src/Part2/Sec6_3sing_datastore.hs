{- 
   ...
   TODO can be made more 'singletons' like
-}
...
module Part2.Sec6_3sing_datastore where
import Data.Singletons.TH
import Control.Applicative ((<|>))
import Data.Monoid ((<>))
import Data.Kind (Type)
import Data.SingBased (Vect(..), Nat(..), Sing(..), someNatToInteger) 
...
import Part2.Sec6_3_datastore (replWith)
...
{-| 
  ...
  convention here.
  TODO use singletons artifacts instead
-}

|Markdown version of this file: https://github.com/rpeszek/IdrisTddNotes/wiki/Part2_Sec9_2_hangman
|Idris Src: Sec9_2_hangman.idr
...
> 
> module Part2.Sec9_2_hangman where
> import Data.SingBased -- TODO spell out what is imported (uses Vect, Nat, List)
> import Part2.Sec8_3_deceq (DecEqSing(..), Dec(..))
> import Part2.Sec9_1_elem (isElemSing, removeElem)

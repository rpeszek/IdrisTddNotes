|Markdown version of this file: https://github.com/rpeszek/IdrisTddNotes/wiki/idrVsHs_Part2_Sec3_2_3
|Idris Src: Sec3_2_3.idr
...
Idris code example
------------------  
|IdrisRef: Sec3_2_3.idr   

Idris does not have a problem with generating map for Vector, but coding map for a List 
would require some manual work.

Type holes (for `mapV2`) provide information superior to what is available in ghci (ghci
information about index types is not that good)

idris repl
```
*src/Part2/Sec3_2_3> :t mapV2_rhs_1
  b : Type
  a : Type
  f : a -> b
--------------------------------------
mapV2_rhs_1 : Vect 0 b
Holes: Part2.Sec3_2_3.mapV2_rhs_2, Part2.Sec3_2_3.mapV2_rhs_1
*src/Part2/Sec3_2_3> :t mapV2_rhs_2
  b : Type
  a : Type
  f : a -> b
  x : a
...
GHC 8.0.2 appears to provide much less info about DataKinds lifted types like Nat. 
If I type
```
...
Other
* Scheme Presentation about code synthesis based on inputs and outputs https://www.youtube.com/watch?v=OyfBQmvr2Hc 

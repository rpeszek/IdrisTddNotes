|Markdown version of this file: https://github.com/rpeszek/IdrisTddNotes/wiki/idrVsHs_Part2_Sec6_2_2
|Idris Src: Sec6_2_2.idr
...
__Solution using limited string literal__
...
>             | End
>
> {- Interestingly, ghc compiles this without ' ticks 
...
ghci output:
```
*Part2.Sec6_2_2> :t testSFmt
testSFmt :: SFormat ('Number ('Lit " greetings for " ('Str 'End)))
*Part2.Sec6_2_2> :t testGreetings
testGreetings :: Int -> String -> String
*Part2.Sec6_2_2> testGreetings 1000 "You"
